...
Technology.create(:name => "Investice do Infrastruktury", :description => "-2% cena budov
...
Technology.create(:name => "Investice do ekonomiky", :description => "+2% produkce solárů
...
Technology.create(:name => "Investice do průmyslu", :description => "+2% produkce materiálu
...
Technology.create(:name => "Investice do výzkumu", :description => "+2% produkce výzkumných bodů
...
Technology.create(:name => "Investice do koření", :description => "-2% ceny osídlení léna
...
Technology.create(:name => "Investice do armády", :description => "", :price => 400, :max_lvl => 17, :bonus => 0.02, :bonus_type => "A", :image_url => "image/vyskum/i_arm.png", :image_lvl =>"1*7*14")
Technology.create(:name => "Investice do výroby", :description => "+2% kapacita továren
...
Technology.create(:name => "Investice do pěchoty", :description => "+2% kapacita kasáren
...
Technology.create(:name => "Investice do flotily", :description => "+2% kapacita loděnic
...
Technology.create(:name => "Bojová technika", :description => "+2% útok pozemních jednotek", :price => 350, :max_lvl => 15, :bonus => 0.02, :bonus_type => "PF", :image_url => "image/imghra/v011.png", :image_lvl =>"1*7*14")
Technology.create(:name => "Obraná technologie", :description => "+2% HP pozemních jednotek", :price => 450, :max_lvl => 15, :bonus => 0.02, :bonus_type => "PO", :image_url => "image/imghra/v020.png", :image_lvl =>"1*7*14")
Technology.create(:name => "Bojová technika", :description => "+2% útok vesmírnych jednotek", :price => 350, :max_lvl => 15, :bonus => 0.02, :bonus_type => "VF", :image_url => "image/imghra/v030.png", :image_lvl =>"1*7*14")
Technology.create(:name => "Obraná technologie", :description => "+2% HP vesmírnych jednotek", :price => 300, :max_lvl => 15, :bonus => 0.02, :bonus_type => "VO", :image_url => "image/imghra/v040.png", :image_lvl =>"1*7*14")
